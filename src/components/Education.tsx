    ...
    return (
        ...
        >
            ...
            <div className="relative" style={{ paddingLeft: '40px' }}>
                <div className="absolute top-2 bottom-2 timeline-line-animated" style={{ left: '14px' }} />
                    ...
                    >
                        ...
                        >
                            <div className="flex items-start gap-4">
                                ...
                                >
                                    {edu.type === "university" ? <UniversityIcon /> : <HighschoolIcon />}
                                </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm font-medium mb-2" style={{ color: edu.accent }}>
