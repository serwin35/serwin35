...
export default function Header({ onNavigate }: HeaderProps) {
    ...
    return (
        <div
            ...
            style={{
                background: "radial-gradient(ellipse 80% 60% at 50% -10%, rgba(59,130,246,0.08) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 100%, rgba(139,92,246,0.06) 0%, transparent 60%)",
            }}
        >
            {/* Decorative blobs */}
            <div
            ...
            <div className="relative z-10 max-w-4xl w-full mx-auto text-center">
                ...
                >
                    ...
                    >
                        {typedRole}
                        <span className="inline-block w-0.5 h-6 ml-0.5 align-middle animate-pulse" style={{ background: "var(--color-accent)" }} />
                    </span>
                </motion.div>
