...
const projects: Project[] = [
  ...
  {
    title: 'Nexo Sfera API',
    descriptionKey: 'portfolio.desc7',
    projectUrl: 'https://github.com/serwin35/nexo-sfera-api',
    tags: ['.NET 8', 'C#', 'REST API', 'InsERT Nexo'],
    status: 'live',
  ...
  {
    title: 'Usage Stick',
    descriptionKey: 'portfolio.desc9',
    projectUrl: 'https://github.com/serwin35/usage-stick',
    tags: ['ESP32', 'C++', 'Claude', 'Codex'],
    status: 'live',
