  ...
  return (
    <>
      ...
      <nav
        ...
        className="hidden md:flex fixed left-0 top-0 h-full w-16 md:w-20 flex-col items-center justify-center py-8 gap-2 z-20"
        style={{
          background:
            'linear-gradient(to right, rgba(5,8,16,0.98) 60%, rgba(5,8,16,0.4))',
      ...
      <nav
        aria-label="Main navigation"
        className="md:hidden fixed bottom-0 left-0 right-0 z-20 flex items-center justify-around px-2 py-2"
        style={{
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              aria-current={isActive ? 'page' : undefined}
              onClick={() => onNavigate(item.id)}
              className="flex flex-col items-center justify-center p-1.5 rounded-lg transition-all duration-200 min-w-0"
              style={
                isActive
                  ? {
                      background:
            ...
            >
              <item.icon
                ...
                style={{
                  color: isActive ? '#60a5fa' : 'rgba(148,163,184,0.4)',
                }}
                aria-hidden="true"
              />
            </button>
